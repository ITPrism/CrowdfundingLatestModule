            ...
            <div class="<?php echo $projectClass; ?>">
                ...
                <p class="font-small"><?php echo htmlspecialchars($description, ENT_QUOTES, 'UTF-8'); ?>
                    <?php if ($displayReadon) { ?>
                        <a href="<?php echo $projectLink; ?>" rel="nofollow"><?php echo JText::_('MOD_CROWDFUNDINGLATEST_READON'); ?></a>
                    <?php } ?>
                </p>
                <?php } ?>
                ...
                <p class="font-xxsmall bolder"><?php echo JText::sprintf('MOD_CROWDFUNDINGLATEST_GOAL', $money->setAmount($project->goal)->formatCurrency(), $money->setAmount($project->funded)->formatCurrency()); ?></p>
                <?php } ?>
            </div>
    ...
    <?php if ($displaySeeProjects) { ?>
        <div class="row">
            <div class="col-md-12 center">
                <a href="<?php echo JRoute::_(CrowdfundingHelperRoute::getDiscoverRoute()); ?>" rel="nofollow" class="btn btn-primary btn-lg"><?php echo JText::_('MOD_CROWDFUNDINGLATEST_SEE_PROJECTS'); ?></a>
            </div>
        </div>
    <?php } ?>
</div>